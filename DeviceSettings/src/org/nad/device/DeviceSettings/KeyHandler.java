...
import org.nad.device.DeviceSettings.Constants;
import org.nad.device.DeviceSettings.DeviceSettings;
import org.nad.device.DeviceSettings.R;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private Context getResContext(Context context) {
        Context resContext;
        try {
            resContext = context.createPackageContext("org.nad.device.DeviceSettings",
