...
*
*/
package org.nad.device.DeviceSettings;
...
import org.nad.device.DeviceSettings.FileUtils;
import org.nad.device.DeviceSettings.doze.DozeSettingsActivity;
import org.nad.device.DeviceSettings.preferences.ProperSeekBarPreference;
import org.nad.device.DeviceSettings.preferences.VibratorCallStrengthPreference;
import org.nad.device.DeviceSettings.preferences.VibratorNotifStrengthPreference;
import org.nad.device.DeviceSettings.preferences.VibratorStrengthPreference;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), org.nad.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
