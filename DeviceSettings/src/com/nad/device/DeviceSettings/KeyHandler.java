...
import com.nad.device.DeviceSettings.Constants;
import com.nad.device.DeviceSettings.DeviceSettings;
import com.nad.device.DeviceSettings.R;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private Context getResContext(Context context) {
        Context resContext;
        try {
            resContext = context.createPackageContext("com.nad.device.DeviceSettings",
